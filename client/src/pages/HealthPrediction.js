...
const HealthPrediction = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6">
      ...
      <p className="text-sm sm:text-base text-slate-600 mb-6 sm:mb-8 text-center px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div 
          ...
          className="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 md:p-8 cursor-pointer hover:shadow-xl transition-all border-2 border-transparent hover:border-teal-500"
        >
          <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3 md:space-y-4">
            <div className="bg-teal-100 p-2 sm:p-3 md:p-4 rounded-full">
              <Activity className="text-teal-600 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" />
            </div>
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-slate-800">General Prediction</h2>
        ...
        <div 
          ...
          className="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 md:p-8 cursor-pointer hover:shadow-xl transition-all border-2 border-transparent hover:border-blue-500"
        >
          <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3 md:space-y-4">
            <div className="bg-blue-100 p-2 sm:p-3 md:p-4 rounded-full">
              <FileText className="text-blue-600 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" />
            </div>
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-slate-800">Report Analysis</h2>
            <p className="text-xs sm:text-sm md:text-base text-slate-600">
