...
import { Eye, Mail, X, ArrowLeft } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center p-3 sm:p-4">
          <div className="bg-white rounded-xl shadow-lg w-full max-w-lg">
            <div className="p-4 sm:p-6 border-b flex justify-between items-center">
              ...
              <button onClick={() => setSelectedQuery(null)} className="p-1.5 sm:p-2 rounded-full hover:bg-slate-100">
            ...
            <div className="p-4 sm:p-6 border-t flex flex-col sm:flex-row justify-end gap-2 sm:gap-4">
              <button onClick={() => setSelectedQuery(null)} className="bg-slate-100 text-slate-700 px-4 sm:px-6 py-2 rounded-full hover:bg-slate-200 transition-all font-medium text-sm sm:text-base">Close</button>
              <a href={`mailto:${selectedQuery.email}`} className="bg-teal-600 text-white px-4 sm:px-6 py-2 rounded-full hover:bg-teal-700 transition-all font-medium flex items-center justify-center gap-2 text-sm sm:text-base">
